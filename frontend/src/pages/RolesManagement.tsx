...
export default function RolesManagement() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm('Are you sure you want to delete this admin and their role?')) return;

    try {
      // First get the user to find their custom role
      const usersWithRole = users.filter(u => u.customRoleId === id);
      
      // Delete the role (this will cascade delete permissions)
